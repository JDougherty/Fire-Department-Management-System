...
bool DatabaseManager::init_structure(){
    ...
    strQuery=""
             ...
             "CREATE TABLE calls ("
                 ...
                 "MaterialFirstIgnited TEXT,"
                 "HumanFactorsIgnition INTEGER,"
                 "HumanFactorAge TEXT,"
                 "HumanFactorSex TEXT,"
                 "HumanFactors TEXT,"
                 "EquipmentFactorsIgnition INTEGER,"
                 "MobilePropertyType TEXT,"
                 "MobilePropertyMake TEXT,"
                 "EquipmentInvolved TEXT,"
                 "EquipmentPortability TEXT,"
                 "EquipmentPower TEXT,"
                 "StructureType TEXT,"
                 "BuildingStatus TEXT,"
                 "BuildingHeightStories INTEGER,"
                 "MainFloorSizeFt INTEGER,"
...
bool DatabaseManager::verify_structure(){
    ...
    if(chksum!="6825945738232854e5a8c12cc8364350"){
        return false;
    }
